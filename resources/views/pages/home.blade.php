...
<link rel="stylesheet" href="{{ asset('assets/frontend-assetss/css/responsive.css') }}" />
...
<div id="carouselExampleIndicators" class="carousel slide container my-2" data-bs-ride="carousel">
    <div class="carousel-indicators" style="justify-content: start;margin-left: 100px;margin-bottom:20px">
        ...
        height: 15px;
        border-radius: 50%;" data-bs-target="#carouselExampleIndicators" data-bs-slide-to="{{ $key }}" class="active" aria-current="true" aria-label="Slide {{ $slider->id }}">
        </button>
        @endforeach
    </div>
    <div class="carousel-inner">
        ...
        <div class="carousel-item {{ $loop->index == 0 ? 'active' : '' }}">
            <a href="{{ $slider->url }}"><img src="{{ Voyager::image($slider->image) }}" class="d-block w-100 " style="height: 450px;
                ...
                <div class="ec_cat_slider">
                    ...
                    <div class="ec_cat_content">
                        <div class="ec_cat_inner">
                            <div class="category-thumbnail border-hover" style="background-color: #f5f5f5;height: 200px;">
                                <a href="{{ route('shops', ['category' => $prodcat->slug]) }}"><img style="height: 100%" src="{{ Storage::url($prodcat->logo) }}" class="card-img-top " alt="..."></a>
                            </div>
                            <p class="card-title p-3" style="font-size: 15px;text-align:center">
                                {{ $prodcat->name }}
                            </p>
            ...
            <div class=" col-md-12">
                ...
                {{--
                    <div class=" d-flex justify-content-center  align-items-center mt-4">
                        <a href="" class="btn btn-dark rounded rounded-3 px-5">View More Shops <i
