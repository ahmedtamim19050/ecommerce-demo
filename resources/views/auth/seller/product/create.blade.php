                                ...
                                <div class="avatar-upload">
                                    ...
                                    <div class="avatar-preview ec-preview">
                                        <div class="imagePreview ec-div-preview">
                                            <img class="ec-image-preview" src="{{asset('assets/img/upload.jpg')}}" alt="edit" />
                                        </div>
                                    </div>
                                </div>
                                <div class="thumb-upload-set colo-md-12">
                                    <div class="thumb-upload">
                                        <div class="thumb-edit">
                                            <input type='file' id="thumbUpload01" name="images[0]" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"><i class="fi-rr-edit"></i></label>
                                        </div>
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                                                <img class="image-thumb-preview ec-image-preview" src="{{asset('assets/img/upload.jpg')}}" alt="edit" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="thumb-upload">
                                        <div class="thumb-edit">
                                            <input type='file' id="thumbUpload02" name="images[1]" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"><i class="fi-rr-edit"></i></label>
                                        </div>
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                                    ...
                                    <div class="thumb-upload">
                                        <div class="thumb-edit">
                                            <input type='file' id="thumbUpload03" name="images[2]" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"><i class="fi-rr-edit"></i></label>
                                        </div>
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                                    ...
                                    <div class="thumb-upload">
                                        <div class="thumb-edit">
                                            <input type='file' id="thumbUpload04" name="images[3]" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"><i class="fi-rr-edit"></i></label>
                                        </div>
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                                    ...
                                    <div class="thumb-upload">
                                        <div class="thumb-edit">
                                            <input type='file' id="thumbUpload05" name="images[4]" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"><i class="fi-rr-edit"></i></label>
                                        </div>
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                                    ...
                                    <div class="thumb-upload">
                                        <div class="thumb-edit">
                                            <input type='file' id="thumbUpload06" name="images[5]" class="ec-image-upload" accept=".png, .jpg, .jpeg" />
                                            <label for="imageUpload"><i class="fi-rr-edit"></i></label>
                                        </div>
                                        <div class="thumb-preview ec-preview">
                                            <div class="image-thumb-preview">
                        ...
                        <div class="ec-vendor-upload-detail">
                            <div class="row g-3">
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror" name="name" id="inputEmail4">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <select class=" @error('categories') is-invalid @enderror" multiple data-placeholder="Select Categories" name="categories[]">
                                ...
                                <div class="col-md-6 mt-2">
                                    ...
                                    <input type="text" name="sale_price" value="{{old('sale_price')}}" class="form-control" id="salePrice">
                                ...
                                <div class="col-md-12 mt-2">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" rows="4" id="description">{{old('description')}}</textarea>
                                ...
                                <input type="hidden" name="post_code" value="{{auth()->user()->shop->post_code}}">
