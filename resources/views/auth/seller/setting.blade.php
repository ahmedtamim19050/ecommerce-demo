                                ...
                                <div class="row">
                                    <div class="col-md-6 my-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('ac_holder_name') is-invalid @enderror" id="ac_holder_name" value="{{ auth()->user()->verification->ac_holder_name }}" placeholder="Account Holder Name" name="ac_holder_name">
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('rtn') is-invalid @enderror" id="rtn" value="{{ auth()->user()->verification->rtn }}" placeholder="Routing Transit Number" name="rtn">
                                            @error('rtn')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-group">
                                            <label for="ein">Paypal Account</label>
                                            <input type="text" class="form-control @error('paypal') is-invalid @enderror" id="paypal" value="{{ auth()->user()->verification->paypal }}" placeholder="Paypal Account for payouts" name="paypal">
                                            @error('paypal')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bank_ac') is-invalid @enderror" id="bank_ac" value="{{ auth()->user()->verification->bank_ac }}" placeholder="Bank Account number" name="bank_account_number">
                                    ...
                                    <div class="col-md-6 my-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control @error('bank_account_number_confirmation') is-invalid @enderror" id="bank_account_number_confirmation" value="{{ auth()->user()->verification->bank_ac }}" placeholder="Bank Account number" name="bank_account_number_confirmation">
