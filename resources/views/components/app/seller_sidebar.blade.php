            ...
            <div class="modal-body">
                <form method="post" action="{{ route('vendor.logo.cover') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" required name="logo" id="logo" aria-describedby="emailHelp">
                    </div>
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('vendor.logo.cover') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" required name="banner" id="banner" aria-describedby="emailHelp" ]>
                    </div>
