        ...
        <div class="invoice-info row">
            ...
            <div class="customer-info col-md-6">
                ...
                <!-- <p>Phone: {{$order->phone}}</p> -->
                    ...
                    <p class=""> <span style="font-weight: 800;"> Address: </span> {{$order->address}},{{$order->city}},{{ $order->state }},{{$order->postCode}}</p>
            ...
            <tbody>
                @foreach ($order->products as $product)
                    <tr>
                        ...
                        <td>{{ Sohoj::price($order->vendor_price) }}</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
                ...
                <tr>
                    ...
                    <td>{{ Sohoj::price($order->vendor_total) }}</td>
                </tr>
            </tfoot>
        </table>
